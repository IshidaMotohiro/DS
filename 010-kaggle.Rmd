...
左のメニューでCompetetitions  をクリックすると、コンペ一覧が表示される。
...
![](images/kaggle_accept.png)

これで Titanic コンペに登録し、参加できることになっている。

![](images/titanic_accept.png)
...
Code タブから  New Notebook をクリックする。

![](images/kaggle_new_notebook.png)
...
### Kernelの公開設定について{#kernel_public}

ここで**公開設定**を行う。この授業課題となるカーネルでは、すべて以下のように Share 設定を Public としておくこと。これにより、あなたのカーネルは全世界の人が閲覧できるようになる。したがって、*学生番号などの個人情報を記載しない* ように注意すること。

![](images/titanic_public.png)
