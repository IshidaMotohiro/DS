...
If you find it difficult to read Japanese texts, do not hesitate to use a translation service, like https://www.deepl.com
 	
## ２０２２年度授業の進め方について{#ds2022}
...
なお、本年度は、コロナウイルスの感染拡大対策のため、４月１５日から６月２４日までの１０回の講義については、キャンパスの教室での授業は行いません。この間の講義は、各自が、manaba で指定されたコンテンツ（このページ）にアクセスし、コンテンツごとに指定された課題（あるいは小テスト）を期限内に回答することで出席したものとみなします。
...
ただし、受講生を専攻ごとに３つのクラスに分け、それぞれのクラスごとに教員が配置されます（ただし、留学生の皆様は全員Cクラスの所属とします。） 
...
Students will be divided into three classes according to their majors. However, **all international students will belong to Class C.**

For each class, please access the contents as instructed by the class instructor. Please be sure to log in using your university C account. If your identity cannot be verified, your attendance may not be recognized.
...
- 生物資源
    - 応用生命科学コース
    - 食料生物科学コース
    - 生物生産科学コース（ただし、留学生はふくまれない）
- 地域創成
    - 臨床心理学専攻
    - 地域創成専攻　　　（ただし、留学生はふくまれない）
- 理工学
    - 社会基盤デザインコース
    - 応用化学システムコース

以上の受講生の担当教員は　石田　基広　(ISHIDA Motohiro)です。　

[Aクラスの会議室](https://teams.microsoft.com/l/meetup-join/19%3ameeting_NDU1Y2RlYTEtNmFkYS00NWNiLTgyNDctMDhiMmM2ZDM3OTEy%40thread.v2/0?context=%7b%22Tid%22%3a%228671c3a4-4538-47f6-8717-16a1d6b0ca98%22%2c%22Oid%22%3a%22b2357fe5-a3cb-4f3c-9244-d114b082b31b%22%7d){target=_blank}
...
以上の受講生の担当教員は　谷岡　広樹　(TANIOKA Hiroki) です。　

[Bクラスの会議室](https://uss.ait.tokushima-u.ac.jp/?id=5LGc1Hbz){target=_blank}
...
以上の受講生の担当教員は　宋　天 (SONG Tian) です。

[Cクラスの会議室](https://teams.microsoft.com/l/meetup-join/19%3ameeting_NWFkNDc2NDItZjlmOC00ZDkzLWExZDMtZTg5ZGViZDYxMzU1%40thread.v2/0?context=%7b%22Tid%22%3a%228671c3a4-4538-47f6-8717-16a1d6b0ca98%22%2c%22Oid%22%3a%22aa3ea8b4-8184-440f-8c77-d3a3ffae2f1e%22%7d){target=_blank}
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/auJJrHgG9Mc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
